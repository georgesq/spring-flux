...
import com.appsdeveloperblog.reactive.ws.users.infrastructure.filter.JwtAuthenticationFilter;
    ...
    SecurityWebFilterChain httpSecurityFilterChain(ServerHttpSecurity http,
        ...
        return http
                .authorizeExchange(exchanges->exchanges
                        ...
                        .pathMatchers(HttpMethod.POST, "/v1/authenticate").permitAll()
                        .pathMatchers(HttpMethod.GET, "/v1/users/stream").permitAll()
